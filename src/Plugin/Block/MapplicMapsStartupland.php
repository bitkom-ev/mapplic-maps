...
/**
 * @file
 * Contains \Drupal\mapplic_maps\Plugin\Block\MapplicMapsStartupland.
 */
 ...
 *
 * @Block(
 *   id = "mapplic_maps_startupland_block",
 *   admin_label = @Translation("Mapplic Maps Startupland block"),
 *   category = @Translation("Mapplic Maps Startupland block")
 * )
 */
class MapplicMapsStartupland extends BlockBase {
  ...
  public function build() {
    ...
    $mapplicMapsSettings = [
      'mapplic_maps' => [
        'action' => 'tooltip',
        'source' => $base_url . "/maps/data/startupland.json",
