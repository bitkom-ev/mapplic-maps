...
/**
 * @file
 * Contains \Drupal\mapplic_maps\Controller\LaenderstartupsController.
 */
 ...
 */
class LaenderstartupsController extends ControllerBase {

  public function _mapplic_maps_laenderstartups_json() {
    $settings = [
      'mapwidth' => "600",
      'mapheight' => "800",
      'categories' => ['Länder Startups'], // /taxonomy/term/825
      'levels' => [],
    ];
    ...
    try {
      ...
      $settings['levels'][0]['title'] = 'Deutsche Bundesländer für Startupland';
