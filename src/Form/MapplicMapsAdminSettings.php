...
/**
 * @file
 * Contains \Drupal\mapplic_maps\Form\MapplicMapsAdminSettings.
 */

namespace Drupal\mapplic_maps\Form;
...
class MapplicMapsAdminSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'mapplic_maps_admin_settings';
  }
  ...
  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
    ...
    $form['mapplic_maps'] = [
      '#title' => t('Mapplic Maps'),
      '#description' => t('SVG Map for the Mapplic Maps'),
      '#required' => TRUE,
      '#upload_location' => 'public://',
      '#default_value' => $config->get('mapplic_maps'),
      '#type' => 'managed_file',
      '#upload_validators'  => [
    ...
    $form['mapplic_map_source'] = [
      '#title' => t('Map json source file'),
      '#description' => t('Map json source file.'),
      '#required' => TRUE,
      '#default_value' => $config->get('mapplic_map_source') ?? 'modules/contrib/mapplic_maps/libraries/mapplic_maps/html/deutschland.json' ,
      '#type' => 'textfield',
    ];
